...
urlpatterns = [
    ...
    path('adminlogin', LoginView.as_view(template_name='school/adminlogin.html'), name='adminlogin'),
    path('studentlogin', LoginView.as_view(template_name='school/studentlogin.html'), name='studentlogin'),
    path('teacherlogin', LoginView.as_view(template_name='school/teacherlogin.html'), name='teacherlogin'),
...
# Teacher scheduling
    ...
    path('teacher-view-schedule', views.teacher_view_schedule_view, name='teacher-view-schedule'),

# Admin viewing all scheduled classes
...
path('admin-edit-schedule/<int:pk>', views.admin_edit_schedule_view, name='admin-edit-schedule'),
path('admin-delete-schedule/<int:pk>', views.admin_delete_schedule_view, name='admin-delete-schedule'),



# Student viewing schedule
   path('student-view-schedule', views.student_view_schedule_view, name='student-view-schedule'),
